...
$result=mysqli_query($koneksi,$query);
	...
	// tampilkan kotak pencarian dan jumlah hasil pencarian
	  ...
	  echo "<br /><br><table><tr><td></td><td><form action='searchskulczynski_i2.php' method='GET'><img src='assets/images/' alt=''> <br><input type='text' onclick=value='' size='50' name='keyword' value='$keyword' style='width: 500px; height: 30px; font-size: 16px;'>  <input type='submit' value='Cari'></form></td></tr></table>";
